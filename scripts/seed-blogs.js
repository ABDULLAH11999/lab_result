...
const topics = [
  ...
  ["vitamin-d-25oh-levels", "25-Hydroxy Vitamin D Levels Explained", "25 hydroxy vitamin D levels, vitamin D 25 OH blood test, vitamin D lab results", "Understand what the 25-OH vitamin D test measures, why doctors use it, and what low or high results may mean."],
  ["crp-high-meaning", "High CRP Meaning: What a C-Reactive Protein Test Can Show", "high CRP meaning, c-reactive protein blood test, CRP elevated causes", "A calm explanation of CRP, why it rises with inflammation, and how it fits into broader lab work."],
  ["esr-high-meaning", "High ESR Meaning: What an Elevated Sed Rate Can Suggest", "high ESR meaning, ESR blood test high, sed rate elevated", "Learn why ESR can be slow to change, what it reflects, and why it is usually read with symptoms and other markers."],
  ["uric-acid-high-blood-test", "High Uric Acid on a Blood Test: What It May Mean", "high uric acid blood test, uric acid elevated meaning, gout blood test", "See how uric acid is connected to gout risk, kidney function, diet, and hydration."],
  ["magnesium-low-meaning", "Low Magnesium Meaning: Why This Electrolyte Matters", "low magnesium meaning, magnesium blood test low, hypomagnesemia explained", "Understand magnesium, why it can fall, and why doctors may look at related electrolytes and medicines."],
  ["phosphorus-high-meaning", "High Phosphorus Meaning on Blood Work", "high phosphorus meaning, phosphate blood test high, hyperphosphatemia explained", "A patient-friendly guide to phosphorus, kidney function, and why timing and lab context matter."],
  ["chloride-low-explained", "Low Chloride Explained: What This Electrolyte Result May Mean", "low chloride explained, chloride blood test low, hypochloremia causes", "Learn how chloride fits with sodium, bicarbonate, vomiting, dehydration, and acid-base balance."],
  ["bicarbonate-co2-low-high", "Bicarbonate (CO2) Blood Test Explained", "bicarbonate blood test explained, CO2 low meaning, CO2 high blood test", "A plain-English guide to bicarbonate, acid-base balance, and what low or high values can suggest."],
  ["sodium-potassium-ratio", "Sodium to Potassium Ratio: Why Doctors Look at the Pattern", "sodium potassium ratio, electrolyte ratio blood test, sodium and potassium labs", "See why the balance between sodium and potassium can matter more than either number alone."],
  ["ferritin-vs-iron", "Ferritin vs Iron: What Each Lab Test Tells You", "ferritin vs iron, ferritin blood test meaning, serum iron explained", "Understand the difference between iron stores and circulating iron, and why doctors often order both."],
  ["tsh-low-high-thyroid", "Low or High TSH Explained: What Thyroid Blood Tests Mean", "low TSH meaning, high TSH meaning, thyroid blood test TSH", "A simple guide to TSH, how it responds to thyroid hormone levels, and what doctors usually check next."],
  ["a1c-vs-fasting-glucose", "HbA1c vs Fasting Glucose: Why Both Tests Matter", "A1C vs fasting glucose, HbA1c and fasting blood sugar, diabetes lab tests", "Learn how long-term and same-day glucose measures work together in diabetes screening and follow-up."],
  ["albumin-globulin-ratio", "Albumin to Globulin Ratio Explained", "albumin globulin ratio, A/G ratio blood test, albumin globulin ratio low", "Understand what the A/G ratio is, why it changes, and how liver, kidney, and immune patterns can affect it."],
  ["alkaline-phosphatase-vs-ggt", "Alkaline Phosphatase vs GGT: Why Doctors Compare Both Liver Tests", "ALP vs GGT, alkaline phosphatase and GGT, liver enzyme pattern", "See how ALP and GGT help doctors tell whether a liver or bile duct pattern is more likely."],
  ["leukocyte-differential-explained", "Leukocyte Differential Explained: Neutrophils, Lymphocytes, and More", "leukocyte differential explained, white blood cell differential, CBC differential meaning", "A practical guide to the white blood cell differential and why different patterns point in different directions."],
  ["creatinine-egfr-hydration", "Creatinine, eGFR, and Hydration: How Kidney Numbers Fit Together", "creatinine eGFR hydration, kidney function blood test, high creatinine dehydration", "Learn why hydration, muscle mass, and repeat testing can change how kidney labs are read."],
  ["fasting-insulin-resistance", "Fasting Insulin and Insulin Resistance Explained", "fasting insulin resistance, high fasting insulin meaning, insulin blood test", "A plain-English guide to fasting insulin, metabolic health, and why it is interpreted with glucose and A1C."],
  ["lipid-panel-triglycerides-hdl", "Lipid Panel Triglycerides and HDL Explained", "lipid panel triglycerides HDL, cholesterol blood test explained, HDL triglycerides meaning", "Understand how triglycerides and HDL fit into the full lipid panel and why the pattern matters."],
  ["blood-test-flagged-high-low", "Why Blood Tests Get Flagged High or Low", "blood test flagged high low, lab result high low meaning, abnormal lab results explained", "A guide to reference ranges, minor variations, and why one flagged result does not tell the whole story."]
];
